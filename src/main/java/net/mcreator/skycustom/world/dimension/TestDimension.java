...
package net.mcreator.skycustom.world.dimension;
...
import net.mcreator.skycustom.SkycustomModElements;
...
@SkycustomModElements.ModElement.Tag
public class TestDimension extends SkycustomModElements.ModElement {
	@ObjectHolder("skycustom:test")
	public static final ModDimension dimension = null;
	public static DimensionType type = null;
	private static Biome[] dimensionBiomes;
	public TestDimension(SkycustomModElements instance) {
		super(instance, 2);
	...
	public void onRegisterDimensionsEvent(RegisterDimensionsEvent event) {
		if (DimensionType.byName(new ResourceLocation("skycustom:test")) == null) {
			DimensionManager.registerDimension(new ResourceLocation("skycustom:test"), dimension, null, false);
		}
		type = DimensionType.byName(new ResourceLocation("skycustom:test"));
	}
